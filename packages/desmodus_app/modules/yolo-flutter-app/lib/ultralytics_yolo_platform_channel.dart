...
class PlatformChannelUltralyticsYolo implements UltralyticsYoloPlatform {
  ...
  @override
  Future<String?> setFlashlightValue(bool value) => methodChannel
      .invokeMethod<String>('setFlashlightValue', {'value': value});

  @override
  Future<String?> takePicture() => methodChannel
      .invokeMethod<String>('takePicture')
      .catchError((dynamic e) => e.toString());
  ...
  @override
  Future<String?> pauseLivePrediction(int direction) =>
      methodChannel.invokeMethod<String>('pauseLivePrediction',
          {"direction": direction}).catchError((dynamic e) => e.toString());

  @override
  Future<String?> resumeLivePrediction(int direction) =>
      methodChannel.invokeMethod<String>('resumeLivePrediction',
          {"direction": direction}).catchError((dynamic e) => e.toString());
